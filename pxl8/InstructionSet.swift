...
class InstructionSet
{
    ...
    static func SYS(nnn: UInt16)
    {
        print("Warning! Not implemented.")
    }
    
    // 00E0 - Clears the screen
    static func CLS(_ cpu: CPU)
    {
        for row in 0..<32 {
            for column in 0..<64 {
    ...
    static func JMP(_ cpu: CPU, nnn: UInt16)
    {
        cpu.pc = nnn
    }
    ...
    static func SKEQ(_ cpu: CPU, x: UInt8, nn: UInt8)
    {
        cpu.pc += 2
    ...
    static func SKNE(_ cpu: CPU, x: UInt8, nn: UInt8)
    {
        cpu.pc += 2
    ...
    static func SKEQ(_ cpu: CPU, x: UInt8, y: UInt8)
    {
        cpu.pc += 2
    ...
    // 6XNN - Sets VX to NN
    static func MOV(_ cpu: CPU, x: UInt8, nn: UInt8)
    {
        cpu.V[x] = nn
        cpu.pc += 2
    }
    ...
    static func MOV(_ cpu: CPU, x: UInt8, y: UInt8)
    {
        cpu.V[x] = cpu.V[y]
        cpu.pc += 2
    }
    ...
    static func SHR(_ cpu: CPU, x: UInt8, y: UInt8)
    {
    ...
    static func SHL(_ cpu: CPU, x: UInt8, y: UInt8)
    {
        cpu.V[0xF] = cpu.V[x] >> 7
    ...
    static func SKNE(_ cpu: CPU, x: UInt8, y: UInt8)
    {
        cpu.pc += 2
    ...
    static func MVI(_ cpu: CPU, nnn: UInt16)
    {
        cpu.I = nnn
        cpu.pc += 2
    }
    ...
    static func JMI(_ cpu: CPU, nnn: UInt16)
    {
    ...
    static func SKP(_ cpu: CPU, x: UInt8)
    {
    ...
    static func SKNP(_ cpu: CPU, x: UInt8)
    {
        if (cpu.key[cpu.V[x]] == 0) {
            cpu.pc += 2
        }
    ...
    static func GDELAY(_ cpu: CPU, x: UInt8)
    {
    ...
    static func KEY(_ cpu: CPU, x: UInt8)
    {
    ...
    static func SDELAY(_ cpu: CPU, x: UInt8)
    {
    ...
    static func SSOUND(_ cpu: CPU, x: UInt8)
    {
    ...
    static func FONT(_ cpu: CPU, x: UInt8)
    {
